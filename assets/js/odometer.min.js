...
(function () {
  ...
  (q = '<span class="xbo-value"></span>'),
    (n =
      '<span class="xbo-ribbon"><span class="xbo-ribbon-inner">' +
      q +
      "</span></span>"),
    (d =
      '<span class="xbo-digit"><span class="xbo-digit-spacer">8</span><span class="xbo-digit-inner">' +
      n +
      "</span></span>"),
              ...
              (function (a) {
                ...
                return (
                  ...
                  (window.jQuery.fn[a] = function (a) {
                    var c;
                    return null == a ||
                      null == (null != (c = this[0]) ? c.xbo : void 0)
    ...
    (m = (function () {
      function a(b) {
        var c,
          ...
          p = this;
        if (
          ((this.options = b), (this.el = this.options.el), null != this.el.xbo)
        )
          return this.el.xbo;
        ...
        (a.prototype.update = function (a) {
          ...
          return (
            ...
            (b = a - this.value)
              ? (v(
                  this.el,
                  "xbo-animating-up xbo-animating-down xbo-animating"
                ),
                b > 0
                  ? r(this.el, "xbo-animating-up")
                  : r(this.el, "xbo-animating-down"),
                this.stopWatchingMutations(),
                this.animate(a),
                this.startWatchingMutations(),
                setTimeout(function () {
            ...
            return (
              ...
              (g = function () {
                ...
                return u() - f > h.options.duration
                  ? ((h.value = a), h.render(), void z(h.el, "xbodone"))
                  : ((i = u() - e),
                    i > b &&
                      ((e = u()),
              ...
              for (
                l = D[m],
                  ...
                  null == (u = this.ribbons)[m] &&
                    (u[m] = this.digits[m].querySelector(".xbo-ribbon-inner")),
    ...
    (m.init = function () {
      ...
      if (null != document.querySelectorAll) {
        for (
          b = document.querySelectorAll(m.options.selector || ".xbo"),
            f = [],
            c = 0,
            d = b.length;
          d > c;
